...
export function appReducer(state: AppState, action: DispatchAction): AppState {
  ...
  const newState = (() => {
    switch (type) {
       ...
       * Description: Takes input from the user and will match it against the database contents such
       *              as: songTitle, artist, album etc. If found or not found will  update/return 
       *              state.
       * 
       * Variables:
       *              searchBar: 
